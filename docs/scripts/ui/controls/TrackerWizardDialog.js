   ...
   createHtmlElement(){
        ...
        elDialog.querySelectorAll('.monster-icon').forEach(icon => {
            icon.addEventListener('click', () => {
                ...
                const monsterType = MonsterTrackerEntity.getMonsterTypeFromImagePath(selectedImage);
                if(monsterType.TYPENAME===MonsterTypeGoblin.TYPENAME){elDialog.querySelector('#wizard-name-input').value = MonsterNameService.getGoblinName();}
                if(monsterType.TYPENAME===MonsterTypeOrc.TYPENAME){elDialog.querySelector('#wizard-name-input').value = MonsterNameService.getOrcName();}
                if(monsterType.TYPENAME===MonsterTypeChaosWarrior.TYPENAME){elDialog.querySelector('#wizard-name-input').value = MonsterNameService.getChaosWarriorName();}
                if(monsterType.TYPENAME===MonsterTypeFimir.TYPENAME){elDialog.querySelector('#wizard-name-input').value = MonsterNameService.getFimirName();}
                if(monsterType.TYPENAME===MonsterTypeGargoyle.TYPENAME){elDialog.querySelector('#wizard-name-input').value = MonsterNameService.getGargoyleName();}
                if(monsterType.TYPENAME===MonsterTypeHexer.TYPENAME){elDialog.querySelector('#wizard-name-input').value = MonsterNameService.getHexerName();}
                if(monsterType.TYPENAME===MonsterTypeMummy.TYPENAME){elDialog.querySelector('#wizard-name-input').value = MonsterNameService.getMummyName();}
                if(monsterType.TYPENAME===MonsterTypeSkeleton.TYPENAME){elDialog.querySelector('#wizard-name-input').value = MonsterNameService.getSkeletonName();}
                if(monsterType.TYPENAME===MonsterTypeZombie.TYPENAME){elDialog.querySelector('#wizard-name-input').value = MonsterNameService.getZombieName();}
                if(monsterType.TYPENAME===MonsterTypeUnknown.TYPENAME){elDialog.querySelector('#wizard-name-input').value = MonsterNameService.getUnknownName();}
                this._dialogMonsterEntity.monsterType = monsterType;
