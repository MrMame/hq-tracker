...
export function createTrackerWizard() {
    ...
    element.addEventListener('click', () => {
        ...
        let selectedColor = element.querySelector('.color-option.selected').getAttribute('data-color');
        ...
        let selectedImage = element.querySelector('.monster-icon.selected');
        selectedImage.style.backgroundColor = selectedColor;
    });
